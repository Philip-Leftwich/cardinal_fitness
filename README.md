...
Check labels as there has been a mix-up 

And four separate colours for this as they are all different. 



Make two versions one facetted and one with everything on one plot

Remove titles and legend on the right. 

Colour scheme needs to be accessible. 



Smurf separated by smurf: cd 225 needs to be cd 225R all through. 

Produce tables for smurf figures

Make smurf negative check prism figure for blue



XA supplementation remove 24 - and check for lines that shouldn't exist. 

Get rid of C-+ and have individual colours for labels. 



Q PCR change to other measurement scale - and then fix for permutation t-test
...
# Fig 5 Transhet survival - is in blood\_feeding.R Transehet
